...
Main:
	...
	LOAD  10          ; period = (10 ms * 10) = 0.1s, or 10Hz.
...
Run1: 
	IN  	XPOS
	SUB     Ft1       ; 8 feets in de2 Units
	JNEG 	Run1       ; DIEs if past 8 feet
...
CorrectedHeading:
	LOAD  AtanX     	;Load Tanx and ensure it is 0
	SUB   AtanX         ;
	ADDI   DIST5 ; Creates x side of right triangle used to calculate heading
	SUB   IdealDistance			;
	...
	LOAD DTheta			;Ensuring that Heading is always 0
	SUB  DTheta			;
	ADDI ATAN2     		; Adding the desired heading to DTheta
...
Check8Feet: 
	IN  	XPOS
	SUB     Ft8       ; 8 feets in de2 Units
	JNEG 	CorrectedHeading       ; DIEs if past 8 feet
	JUMP 	Die 	  ; correct heading and Keep going
...
Ft3:      DW 879
Ft4:      DW 1172
Ft8:      Dw: 2344		;8 feet in de2 lingo

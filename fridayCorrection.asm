...
Test21:		CALL   GetThetaErr ; get the heading error
			CALL   Abs         ; absolute value
			ADDI   -1          ; check if within 1 degree of target
			JPOS   Test21
			JUMP SonarTest2
...
Test22:			CALL   GetThetaErr ; get the heading error
				CALL   Abs         ; absolute value
				ADDI   -1          ; check if within 1 degree of target
				JPOS   Test22
				JUMP SonarTest2
...
Test23:			CALL   GetThetaErr ; get the heading error
				CALL   Abs         ; absolute value
				ADDI   -1          ; check if within 1 degree of target
				JPOS   Test23
				JUMP SonarTest3
...
Test24:			CALL   GetThetaErr ; get the heading error
				CALL   Abs         ; absolute value
				ADDI   -1          ; check if within 1 degree of target
				JPOS   Test24
				JUMP SonarTest3
...
Wait5:			CALL   GetThetaErr ; get the heading error
	  			CALL   Abs         ; absolute value
...
Wait0: 			CALL   GetThetaErr ; get the heading error
	  			CALL   Abs         ; absolute value
				OUT    LCD         ; useful debug info
...
Ft2:      DW 586  
Ft2Half: DW 736     ; ~2ft in 1.04mm units
Ft3:      DW 879
Ft4:      DW 1172
Ft4Half:	DW 1325
Ft1:      DW 292
